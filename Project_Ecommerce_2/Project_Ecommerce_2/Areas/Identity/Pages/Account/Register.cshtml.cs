...
namespace Project_Ecommerce_2.Areas.Identity.Pages.Account
{
        ...
        {
            {
                Input = new InputModel()
                {
                    ...
                    RoleList = _roleManager.Roles.Where(r=>r.Name!= SD.Role_Individual).Where(c=>c.Name!=SD.Role_Admin).
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        if (User.IsInRole(SD.Role_Individual))//role=individual
                        {
